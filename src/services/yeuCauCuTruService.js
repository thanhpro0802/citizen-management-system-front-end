...
export const taoYeuCau = (data) => yeuCauCuTruService.taoYeuCau(data).then((res) => res.data);
...
export const thongKeYeuCau = () => yeuCauCuTruService.thongKeYeuCau().then((res) => res.data);

export const demYeuCauChoXuLy = () => yeuCauCuTruService.demYeuCauChoXuLy().then((res) => res.data);
